			...
			<div class="container">
				<div class="editContent">
					<ul class="filter">
						...
						<li><a href="#" data-filter=".artwork">Sites</a></li>
						<li><a href="#" data-filter=".creative">Sistemas</a></li>
						<li><a href="#" data-filter=".nature">Blogs</a></li>
						<li><a href="#" data-filter=".outside">E-commerce</a></li>
